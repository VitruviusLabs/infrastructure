...
docker compose -f "${DEVELOPMENT_DOCKER_DIRECTORY}"/docker-compose.yml -p "${COMPANY_NAME}-infrastructure" up -d --build

log "${COLOR_GREEN}Project '${COMPANY_NAME}-infrastructure' running.${COLOR_NONE}"
